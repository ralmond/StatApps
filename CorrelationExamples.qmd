...
server <- function (input,output) {
  ...
  plot(X[1:N],Y,main=paste("Correlation =",rho))
...
Ideally we would fit two linear regression to these data splitting at
a certain value of $X$, $x_0$.  So,
...
Check out [this
page](https://pluto.coe.fsu.edu/rdemos/CorrelationQuiz) to practice
identifying these.
